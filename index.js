...
//
const BotName = 'GusBot'; // Nama Bot Whatsapp
const instagramlu = 'https://www.instagram.com/gusdin_/'; // Nama Instagramlu cok
const whatsapplu = '0819-9782-6183'; // Nomor whatsapplu cok
...
conn.on('user-presence-update', json => console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by GusDin`))
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by GusDin`)
})
